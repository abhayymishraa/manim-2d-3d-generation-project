...
from .supabase_client import delete_job_data, get_job_status, get_job_code, upload_to_supabase, update_job_data
import re
import os
import uuid
import logging
            ...
            if not os.path.exists(full_path):
                ...
                if status == "completed" and video_path:
                    ...
                    if supabase_url:
                        ...
                        logger.info(f"Re-uploaded video for job {job_id} to Supabase: {supabase_url}")
                    else:
                        logger.error(f"Failed to re-upload video for job {job_id} to Supabase")
